...
function DisconnectFromMySQL(PDO &$conn){

}


// Return the state for a bot by name as an array
function GetBotState(PDO &$conn, $name){
...
function LoadInCompleteSentences(PDO &$conn){
...
// is set when this function runs it will limit query
// to only the bot specified.
function LoadCompleteSentences(PDO &$conn){
